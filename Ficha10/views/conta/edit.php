<div class="container">
    <form method="POST" action="index.php?c=conta&a=update&id=<?= $conta->id; ?>">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="inputTitular" name="titular" value="<?php if (isset($conta)) {
                                                                                                    echo $conta->titular;
                                                                                                } ?>">
            </div>
            <?php
            if (isset($conta->errors) && $conta->errors->on('titular')) {
                echo "<div class='alert alert-danger mt-2' role='alert'>" . $conta->errors->on('titular') . "</div>";
            }
            ?>
        </div>
        <div class="row mb-3">
